...
export const useTheme = () => {
  ...
  let baseTheme;
  if (activeScheme === 'oled') baseTheme = oledTheme;
  else if (activeScheme === 'dark') baseTheme = darkTheme;
  else baseTheme = lightTheme;

  return {
    ...baseTheme,
    primary: accentColor || baseTheme.primary,
    primaryLight: accentColor ? `${accentColor}26` : baseTheme.primaryLight,
  };
};
